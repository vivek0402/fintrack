        ...
        <>
            <div className="glass-surface" style={{ borderRadius: 'var(--radius-xl)', padding: '16px 18px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '6px', padding: '8px 10px', background: 'var(--glass-fill-1)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-md)' }}>
                        ...
                        {pickerMonths.map(m => {
                            ...
                            return (
                                <button key={m} type="button" onClick={() => { onPickMonth(m, now.getFullYear()); setMonthSheetOpen(false); }}
                                    style={{ padding: '10px 6px', background: active ? 'var(--accent-subtle)' : 'var(--glass-fill-1)', border: `1px solid ${active ? 'var(--accent-border)' : 'var(--border-subtle)'}`, borderRadius: 'var(--radius-md)', cursor: 'pointer', color: active ? 'var(--accent)' : 'var(--text-secondary)', fontSize: '13px', fontWeight: active ? 600 : 400, fontFamily: 'var(--font-body)' }}>
