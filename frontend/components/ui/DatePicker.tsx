...
interface DatePickerProps {
    ...
    label?: string;
    required?: boolean;
    /** If true, the calendar opens upward (above the trigger) */
    openUpward?: boolean;
...
export function DatePicker({
    ...
    // Keep calMonth/calYear in sync when value changes externally
    useEffect(() => {
        if (value) {
            ...
            <div ref={wrapperRef} style={{ position: 'relative', width: '100%' }}>
                ...
                <div
                    ...
                    style={{
                        ...
                        border: `1px solid ${calOpen ? 'var(--accent-blue)' : 'var(--bg-border)'}`,
                        borderRadius: '10px',
                        padding: '10px 14px',
                ...
                >
                    ...
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
                        style={{ stroke: calOpen ? 'var(--accent-blue)' : 'var(--text-secondary)', flexShrink: 0, transition: 'stroke 0.15s' }}
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7,1fr)', gap: '2px' }}>
                            {buildCalDays(calMonth, calYear).map((cell, i) => {
                                ...
                                return (
                                    <div
                                        key={i}
                                        onClick={() => !isDisabled && handleDayClick(cell.day, cell.month)}
                                        style={{
                                            width: '34px',
                                            height: '34px',
                                            borderRadius: '50%',
                                            ...
                                            opacity: (isOtherMonth && !isSelected) || isDisabled ? 0.4 : 1,
