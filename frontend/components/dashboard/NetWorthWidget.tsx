    ...
    return (
        <Card>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, margin: '14px 0 12px' }}>
                <span style={{ fontSize: '11px', fontWeight: 600, padding: '4px 10px', borderRadius: 999, background: 'var(--bg-alt)', border: '1px solid var(--border)', color: 'var(--text-secondary)', fontFamily: 'var(--font-body)' }}>
