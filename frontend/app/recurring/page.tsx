            ...
            {loading ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    {recurring.map(r => {
                        ...
                        return (
                            <div key={r.id} style={{ background: 'var(--bg-secondary)', border: `1px solid ${r.is_active ? 'var(--bg-border)' : 'var(--bg-card)'}`, borderRadius: '14px', padding: '16px 20px', opacity: r.is_active ? 1 : 0.5, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px' }}>
